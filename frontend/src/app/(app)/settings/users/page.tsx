    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="overflow-x-auto rounded-lg border border-slate-200 dark:border-slate-800">
        <table className="w-full text-sm">
          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.userId} className="border-b border-slate-100 last:border-0 dark:border-slate-800">
                ...
                <td className="px-4 py-2.5 font-mono text-xs text-slate-600 dark:text-slate-400">{user.login}</td>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-6">
      <div className="max-h-[85vh] w-full max-w-3xl overflow-auto rounded-lg border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-950">
        <div className="mb-5">
          ...
          <p className="text-sm text-slate-500">{grid.username}</p>
        </div>
